...
public class NodeCamera : MonoBehaviour
{
    ...
    void Update()
    {
        if(gamemanager.currentNode.CameraFocus.position != transform.position || gamemanager.currentNode.CameraFocus.rotation != transform.rotation)
        {
            ...
            */
            ...
            transform.rotation = Quaternion.Slerp(transform.rotation, gamemanager.currentNode.CameraFocus.rotation, Time.deltaTime * LerpSpeed);
        }
    }
}
